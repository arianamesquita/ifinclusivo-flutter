...
class _ProfilePageState extends State<AccountSecurityPage> {
                                ...
                                constraints: BoxConstraints(
                                  maxWidth:
                                      deviceType == DeviceScreenType.desktop
                                          ...
                                          ? 500
                                          : constraints
                                              .maxWidth, // ocupa tela toda no mobile
                                ),
                                child: Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  icon: Icon(
                    password1Visible ? Icons.visibility_off : Icons.visibility,
                  ),
                  onPressed: () {
                    setState(() {
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  icon: Icon(
                    password3Visible ? Icons.visibility_off : Icons.visibility,
                  ),
                  onPressed: () {
                    setState(() {
                  ...
                  onPressed:
                      state.isRunning
                          ...
                          : () async {
                            ...
                            if (state.isSuccess) {
                              AuthModals.changePasswordSuccess(
                                context: context,
                              );
                            } else {
                          ...
                          : () async {
                            AuthModals.deleteAccount(
                              ...
                              onSendPressed: (
                                ...
                                final result =
                                    viewModel.deleteAccountCommand.value;
                                if (result.isSuccess) {
      ...
      children: [
        Positioned(
          ...
          child: Padding(
            ...
            child: Image.asset('assets/profile/profile1.png', height: 549),
          ),
        ),
      ],
    );
  ...
  _buildMobile(AccountSecurityViewModel viewModel) {
    return Scaffold(
      appBar: AppBar( title: Text('Segurança da Conta'),),
      body: SafeArea(
        child: Padding(
          padding: const EdgeInsets.symmetric( horizontal: 16.0, vertical: 20),
          child: SingleChildScrollView(
            child: buildForm(viewModel),
          ),
        ),
      ),
    );
